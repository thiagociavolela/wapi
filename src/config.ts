...
const schema = z.object({
  ...
  PRODUCT_DB_HOST: z.string().default(""),
  PRODUCT_DB_PORT: z.coerce.number().int().positive().default(3306),
  PRODUCT_DB_USER: z.string().default(""),
  PRODUCT_DB_PASSWORD: z.string().default(""),
  PRODUCT_DB_NAME: z.string().default(""),
  PRODUCT_IMAGE_BASE_URL: z.string().url().default("https://provida.far.br"),
  MERCADO_PAGO_ACCESS_TOKEN: z.string().default(""),
  MERCADO_PAGO_WEBHOOK_SECRET: z.string().default(""),
  MERCADO_PAGO_SUCCESS_URL: z.string().default(""),
  MERCADO_PAGO_FAILURE_URL: z.string().default(""),
  MERCADO_PAGO_PENDING_URL: z.string().default(""),
